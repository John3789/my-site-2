...
<div className="absolute inset-0 bg-gradient-to-b from-black/10 via-black/30 to-black/60" />
        ...
        <h1   className="hero-title font-serif opacity-95 md:drop-shadow-lg md:!text-6xl [@media(orientation:portrait)_and_(max-width:900px)]:!text-[clamp(50px,12vw,66px)] [@media(orientation:landscape)_and_(max-width:900px)]:!text-[6.5vw]">
                  Speaking
                </h1>
...
{/* ---- /mobile quick nav ---- */}
          ...
          <div className="mx-auto max-w-[1400px] md:py-6 space-y-16 md:space-y-24" id="topics">
            <hr className="border-t border-[var(--color-cream)]/22 md:mb-8 mx-auto w-[93%] landscape:mt-1 landscape:mb-4 [@media(orientation:landscape)_and_(max-width:820px)]:mt-15" />
  ...
  <figure className="relative w-full rounded-xl bg-white/5 p-8 mt-10 md:ring-1 md:ring-white/10 md:shadow-2xl md:backdrop-blur-sm hover:bg-white/[0.06] transition">
    ...
    <figcaption className="mt-4 text-[12px] uppercase tracking-[0.18em] opacity-80">
      — <span className="text-[var(--color-gold)]">Angel</span>, National Hispanic Science Network Annual International Conference
            ...
            <hr className="border-t border-[var(--color-cream)]/22 mb-16 md:mb-8 mx-auto w-[93%] [@media(orientation:landscape)_and_(min-width:700px)_and_(max-width:1500px)]:-mt-19" />
...
>
  <figure className="relative w-full rounded-xl bg-white/5 p-8 mt-10 md:ring-1 md:ring-white/10 md:shadow-2xl md:backdrop-blur-sm hover:bg-white/[0.06] transition [@media(orientation:landscape)_and_(min-width:1000px)_and_(max-width:1200px)]:p-5 [@media(orientation:landscape)_and_(min-width:1000px)_and_(max-width:1200px)]:mt-33 [@media(orientation:landscape)_and_(min-width:1000px)_and_(max-width:1200px)]:min-h-[215px]">
    <span aria-hidden className="absolute left-0 top-1 bottom-1 w-[3px] bg-[var(--color-gold)]/70 rounded-l-2xl" />
    <blockquote className="font-serif text-2xl md:text-3xl leading-snug opacity-90 relative [@media(orientation:landscape)_and_(min-width:1000px)_and_(max-width:1200px)]:pl-2.5 [@media(orientation:landscape)_and_(min-width:1000px)_and_(max-width:1200px)]:!text-[27px] [@media(orientation:landscape)_and_(min-width:1000px)_and_(max-width:1200px)]:leading-[1.25 [@media(orientation:landscape)_and_(min-width:1000px)_and_(max-width:1200px)]:mt-2">
      <span aria-hidden data-quote="open"  className="absolute -left-3 -top-1 text-4xl opacity-20 select-none [@media(orientation:landscape)_and_(min-width:1000px)_and_(max-width:1200px)]:left-0">“</span>
      <p>
...
<div className="flex flex-col gap-6 w-full">
  ...
  <figure className="relative w-full rounded-xl bg-white/5 p-8 hover:bg-white/[0.06] transition">
    ...
    <figcaption className="-mt-8 text-[12px] uppercase tracking-[0.18em] opacity-80 [@media(orientation:landscape)_and_(max-width:999px)]:-mt-6 [@media(orientation:portrait)_and_(min-width:375px)_and_(max-width:499px)]:!text-[11px]">
      — <span className="text-[var(--color-gold)]">Cho-Hee</span>, American Public Health Association Annual Meeting &amp; Expo
    </figcaption>
  </figure>
...
<div className="mt-10 flex justify-center w-full landscape:-mb-12 [@media(orientation:landscape)_and_(max-width:999px)]:mt-10 [@media(orientation:landscape)_and_(max-width:999px)]:-mb-15 [@media(orientation:portrait)_and_(min-width:700px)_and_(max-width:799px)]:-mb-8">
  ...
  >
    {showAllTestimonials ? "Show Less" : "Show All"}
            ...
            <div className="lg:hidden -mt-5 mb-17 w-full [@media(orientation:landscape)_and_(max-width:820px)]:mt-21 [@media(orientation:portrait)_and_(min-width:700px)_and_(max-width:799px)]:mt-20">
              <div className="w-full flex justify-center">
                <div className="max-w-[540px] w-full grid grid-cols-[1fr_1.35fr_1fr] gap-3">
                  <button
                    onClick={() => jump("results")}
...
@media (orientation: portrait) and (min-width: 700px) and (max-width: 920px) {
  ...
  /* === iPad PORTRAIT ONLY (≈ 800–950px) — tighten spacing under pills & above button rows === */
@media (orientation: portrait) and (min-width: 800px) and (max-width: 950px) {

  /* 1️⃣ BELOW THE 4 NAV PILLS — trim section bottom padding and pull pills slightly down */
  [data-page="speaking"] #intro {
  ...
  [data-page="speaking"] #programs + .lg\:hidden,

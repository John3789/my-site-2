        ...
        >
          ...
          <section className="relative w-full pt-16 pb-9 md:py-16" id="intro">
            ...
            <div className="mx-auto max-w-[1000px] px-6 text-left space-y-8">
              ...
              <div id="quicknav" className="lg:hidden mt-10 -mb-5 pointer-events-auto">
              ...
              <div className="flex flex-col gap-6 max-w-[640px]">
                ...
                <div className="mt-4 flex justify-center">
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-full border border-white/20 bg-[var(--color-teal-800)] text-[var(--color-cream)] px-4 py-2.5 text-[14px] font-semibold tracking-wide transition hover:bg-[var(--color-teal-700)] active:translate-y-[1px]"
                  >

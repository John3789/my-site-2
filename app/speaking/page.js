        ...
        >
          ...
          <section className="relative w-full pt-16 pb-9 md:py-16" id="intro">
            ...
            <div className="mx-auto max-w-[1000px] px-6 text-left space-y-8">
              ...
              <div id="quicknav" className="md:hidden mt-10 mb-0 pointer-events-auto">
...
<div className="mx-auto max-w-[1400px] space-y-16 px-0 mt-10">
  <hr className="border-t border-[var(--color-cream)]/22 mb-8" />
</div>

<div className="mx-auto max-w-[1400px] space-y-16 px-0">

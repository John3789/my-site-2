...
>
              ...
              <div id="quicknav" className="lg:hidden mt-10 -mb-7 -pb-30 pointer-events-auto landscape:-pb-30 lg:landscape:-pb-none">
                <div className="grid grid-cols-2 landscape:grid-cols-2 gap-2">
                  {SECTIONS.map((s, idx) => (
                    <button
                      ...
                      className={[
                        "landscape:max-w-[520px] mx-auto inline-flex items-center gap-1 rounded-full px-3.5 py-1.5",

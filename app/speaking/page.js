...
>
              ...
              <div id="quicknav" className="lg:hidden pointer-events-auto">
                <div className="grid grid-cols-2 landscape:grid-cols-2 gap-2">
                  {SECTIONS.map((s, idx) => (
                    <button
                      ...
                      className={[
                        "landscape:max-w-[300px] lg:landscape:max-w-none w-full inline-flex items-center gap-1 rounded-full px-3.5 py-1.5 mb-3",

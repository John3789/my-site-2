        ...
        <main className="min-h-screen w-full bg-[var(--color-teal-850)] text-[var(--color-cream)]">
          <div className="mx-auto max-w-[1400px] px-6 py-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-12">
              ...
              <div>
                <p className="mx-auto flex justify-center space-y-6 text-lg mb-4 opacity-90 leading-loose [@media(orientation:landscape)_and_(max-width:999px)]:max-w-[70ch]">
                ...
                <p className="mx-auto flex justify-center space-y-6 text-lg opacity-90 leading-loose [@media(orientation:landscape)_and_(max-width:999px)]:max-w-[70ch]">
            ...
            <div className="mx-auto max-w-[1000px] px-6 space-y-12">
              {/* Paragraph 3 */}
              <p className="space-y-6 text-lg opacity-90 leading-loose [@media(orientation:landscape)_and_(max-width:999px)]:max-w-[70ch]">

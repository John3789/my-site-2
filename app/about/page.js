    ...
    <a href="#credentials" className="w-full inline-flex items-center gap-1 rounded-full px-3.5 py-1.5 text-[12px] font-semibold tracking-wide truncate transition active:scale-95 active:brightness-110 border border-white/15 bg-[var(--color-teal-800)] text-[var(--color-cream)]">
      <span className="inline-block w-[3ch] text-left tabular-nums leading-none">4.</span><span className="truncate">Credentials</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start mb-12">
              ...
              <div>
                <p className="mx-auto space-y-6 text-[clamp(17px,1.6vw,22px)] mb-4 opacity-90 leading-loose [@media(orientation:landscape)_and_(max-width:1200px)]">
                ...
                <p className="mx-auto space-y-6 text-[clamp(17px,1.6vw,22px)] opacity-90 leading-loose [@media(orientation:landscape)_and_(max-width:1200px)]">
...
[@media(orientation:landscape)_and_(max-width:1200px)_and_(max-height:430px)]
              margin-left: auto;
              margin-right: auto;
            }
          }

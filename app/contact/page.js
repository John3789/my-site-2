  ...
  return (
    <main className="relative min-h-screen w-full bg-[var(--color-teal-850)] text-[var(--color-cream)]">
      ...
      <div className="mx-auto max-w-[1200px] px-6 py-20">
        ...
        {/* Body: form + slim info card (desktop only) */}
        <div className="md:grid md:grid-cols-[1fr_340px] md:gap-10">
          {/* LEFT: friendly single card form */}
          <section className="relative overflow-hidden rounded-2xl bg-white/4 ring-1 ring-white/12 p-6 md:p-7 shadow-2xl backdrop-blur-sm">
            <span
              aria-hidden
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {topics.map((t, i) => (
                      <div key={t.value}>
                        ...
                        <label
                          htmlFor={`topic-${i}`}
                          className="cursor-pointer rounded-full border border-white/20 bg-white/5 px-3.5 py-1.5 text-[12px] font-semibold tracking-wide
                                     hover:bg-white/10 peer-checked:bg-[var(--color-gold)] peer-checked:text-black peer-checked:border-[var(--color-gold)] transition"
                        >
                          {t.label}
                        </label>
                      </div>
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center justify-between">
                    <p className="text-[12px] opacity-70">
                      Helpful to include: goals, org/context, timeline.
                    </p>
                ...
                <p className="text-xs opacity-75 leading-relaxed">
                  ...
                  educational, and wellness purposes only. They do not constitute medical advice, diagnosis, or treatment.
                  If you have medical or mental health concerns, please consult a qualified professional.
                </p>
              </form>
            )}
          </section>

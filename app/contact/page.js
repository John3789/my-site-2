    ...
    <>
      ...
      >
        <main className="min-h-screen w-full bg-[var(--color-teal-850)] text-[var(--color-cream)]">
          ...
          {/* ============== MOBILE (inside zoom) ============== */}
          <div className="lg:hidden mx-auto max-w-[1400px] px-6 pt-16">
            {/* Page header */}
              ...
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div
                    ...
                    className="m-0 p-0 relative isolate"
                  >
            ...
            {/* Spacer to match Meditations */}
            <div className="pb-10" />

            {/* FINAL divider above footer — match Meditations */}

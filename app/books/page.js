          ...
          <main className="min-h-screen w-full bg-[var(--color-teal-850)] text-[var(--color-cream)]">
            ...
            <div className="mx-auto max-w-[1400px] px-6 pb-20">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                {/* Left column */}
<div className="mx-auto [@media(orientation:landscape)_and_(max-width:1300px)_and_(max-height:430px)]:max-w-[70ch] [@media(orientation:landscape)_and_(max-width:1300px)_and_(max-height:430px)]:justify-self-center">
...
[@media(orientation:landscape)_and_(max-width:1300px)_and_(max-height:430px)]:max-w-[70ch]
              margin-left: auto;
              margin-right: auto;
            }
          }

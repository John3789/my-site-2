...
export default function BooksPage() {
  // Mobile expand state per card
  const [expand, setExpand] = useState({ c1: false, c2: false, c3: false });
  const toggle = (key) => setExpand((p) => ({ ...p, [key]: !p[key] }));
  ...
  return (
    <TopOnMount>
      <>
          ...
          <main className="min-h-screen w-full bg-[var(--color-teal-850)] text-[var(--color-cream)]">
            ...
            <div className="mx-auto max-w-[1400px] px-6 pb-20">
              ...
              <div className="space-y-10">
                ...
                <article
                  data-truncate="true"
                  data-expanded={expand.c1 ? "true" : "false"}
                  className="w-full bg-white/5 rounded-xl shadow-2xl p-6 md:p-8 lg:p-10 backdrop-blur-0 md:backdrop-blur-sm hover:bg-white/[0.06] transition relative ring-1 ring-white/10"
                >
                  ...
                  <div className="flex flex-col lg:flex-row gap-6 md:gap-10 lg:gap-12">
                    <div className="lg:w-1/3">
                      <p className="text-[11px] md:text-xs uppercase tracking-[0.18em] text-[var(--color-gold)] opacity-90">Theme</p>
                      <div className="h-px w-14 bg-[var(--color-gold)]/30 mt-2 mb-4" />
                      <h3 className="font-serif text-[clamp(20px,5.5vw,28px)] md:text-3xl mb-2 md:mb-3">
                    ...
                    <div className="lg:w-2/3">
                      <ul className="list-none divide-y divide-white/10">
                        <li className="flex gap-3 py-3 md:py-4">
                          <span className="mt-2 md:mt-3 h-2 w-2 rounded-full bg-[var(--color-gold)] shrink-0" />
                          <div>
                            Salerno et&nbsp;al. (2024).
                            ...
                            <a
                              href="https://www.researchgate.net/publication/385788771_Mental_Health_Risk_and_Protection_Among_First-Generation_Latinx_Immigrant_Youth_A_Latent_Profile_Analysis"
                              target="_blank"
                              rel="noreferrer"
                              className="underline decoration-[var(--color-gold)] underline-offset-2 hover:opacity-80"
                            >
                              Read<span className="hidden md:inline"> Here</span> →
                            </a>
                          </div>
                        </li>
                        <li className="flex gap-3 py-3 md:py-4">
                          ...
                          <div>
                            ...
                            <span className="italic"> Health Education &amp; Behavior.</span>{" "}
                            <a
                              href="https://www.researchgate.net/publication/380667864_Effects_of_Racist_Microaggressions_and_Sexual_and_Gender_Minority_Stress_on_Mental_Health_Among_Latinx_Lesbian_Gay_Bisexual_Transgender_and_Queer_or_Questioning_Young_Adults"
                              target="_blank"
                              rel="noreferrer"
                              className="underline decoration-[var(--color-gold)] underline-offset-2 hover:opacity-80"
                            >
                        ...
                        <li className="flex gap-3 py-3 md:py-4">
                          ...
                          <div>
                            ...
                            <a
                              href="https://www.researchgate.net/publication/375071692_Profiles_of_Psychosocial_Stressors_and_Buffers_Among_Latinx_Immigrant_Youth_Associations_with_Suicidal_Ideation"
                              target="_blank"
                              rel="noreferrer"
                              className="underline decoration-[var(--color-gold)] underline-offset-2 hover:opacity-80"
                            >
                        ...
                        <li className="flex gap-3 py-3 md:py-4">
                          ...
                          <div>
                            ...
                            <a
                              href="https://www.researchgate.net/publication/372481962_Impact_of_Racist_Microaggressions_and_LGBTQ-Related_Minority_Stressors_Effects_on_Psychological_Distress_Among_LGBTQ_Young_People_of_Color"
                              target="_blank"
                              rel="noreferrer"
                              className="underline decoration-[var(--color-gold)] underline-offset-2 hover:opacity-80"
                            >
                        ...
                        <li className="flex gap-3 py-3 md:py-4">
                          ...
                          <div>
                            ...
                            <a
                              href="https://www.researchgate.net/publication/360404871_Impact_of_family_rejection_and_racism_on_sexual_and_gender_minority_stress_among_LGBTQ_young_people_of_color_during_COVID-19"
                              target="_blank"
                              rel="noreferrer"
                              className="underline decoration-[var(--color-gold)] underline-offset-2 hover:opacity-80"
                            >
                      ...
                      <div className="md:hidden mt-4">
                        <button
                          onClick={() => toggle("c1")}
                          className="rounded-full border border-white/20 bg-white/5 px-3 py-1.5 text-[12px] font-semibold tracking-wide hover:bg-white/10 active:translate-y-[1px]"
                        >
                          {expand.c1 ? "Show less" : "Show all"}
                        </button>
                      </div>
                    </div>
                  </div>
                ...
                <article
                  data-truncate="true"
                  data-expanded={expand.c2 ? "true" : "false"}
                  className="w-full bg-white/5 rounded-xl shadow-2xl p-6 md:p-8 lg:p-10 backdrop-blur-0 md:backdrop-blur-sm hover:bg-white/[0.06] transition relative ring-1 ring-white/10"
                >
                  <div className="absolute left-0 top-1 bottom-1 w-[3px] bg-[var(--color-gold)]/60 rounded-l-xl" />
                  <div className="flex flex-col lg:flex-row gap-6 md:gap-10 lg:gap-12">
                      ...
                      <ul className="list-none divide-y divide-white/10">
                        ...
                        <li className="flex gap-3 py-3 md:py-4">
                          ...
                          <div>
                            ...
                            <a
                              href="https://www.researchgate.net/publication/361075038_Associations_between_living_arrangement_and_sexual_and_gender_minority_stressors_among_university_students_since_the_start_of_the_COVID-19_pandemic"
                              target="_blank"
                              rel="noreferrer"
                              className="underline decoration-[var(--color-gold)] underline-offset-2 hover:opacity-80"
                            >
                        ...
                        <li className="flex gap-3 py-3 md:py-4">
                          ...
                          <div>
                            ...
                            <a
                              href="https://www.researchgate.net/publication/360505666_LGBTQ_Identity-Related_Victimization_During_COVID-19_Is_Associated_with_Moderate_to_Severe_Psychological_Distress_Among_Young_Adults"
                              target="_blank"
                              rel="noreferrer"
                              className="underline decoration-[var(--color-gold)] underline-offset-2 hover:opacity-80"
                            >
                        ...
                        <li className="flex gap-3 py-3 md:py-4">
                          ...
                          <div>
                            ...
                            <a
                              href="https://www.researchgate.net/publication/352878843_Changes_in_Mental_Health_and_Wellbeing_Are_Associated_With_Living_Arrangements_With_Parents_During_COVID-19_Among_Sexual_Minority_Young_Persons_in_the_US"
                              target="_blank"
                              rel="noreferrer"
                              className="underline decoration-[var(--color-gold)] underline-offset-2 hover:opacity-80"
                            >
                        ...
                        <li className="flex gap-3 py-3 md:py-4">
                          ...
                          <div>
                            ...
                            <a
                              href="https://www.researchgate.net/publication/349479772_Changes_in_Alcohol_Use_Since_the_Onset_of_COVID-19_Are_Associated_With_Psychological_Distress_Among_Sexual_and_Gender_Minority_University_Students_in_the_US"
                              target="_blank"
                              rel="noreferrer"
                              className="underline decoration-[var(--color-gold)] underline-offset-2 hover:opacity-80"
                            >
                ...
                <article
                  data-truncate="true"
                  data-expanded={expand.c3 ? "true" : "false"}
                  className="w-full bg-white/5 rounded-xl shadow-2xl p-6 md:p-8 lg:p-10 backdrop-blur-0 md:backdrop-blur-sm hover:bg-white/[0.06] transition relative ring-1 ring-white/10"
                >
                  <div className="absolute left-0 top-1 bottom-1 w-[3px] bg-[var(--color-gold)]/60 rounded-l-xl" />
                  <div className="flex flex-col lg:flex-row gap-6 md:gap-10 lg:gap-12">
                      ...
                      <ul className="list-none divide-y divide-white/10">
                        <li className="flex gap-3 py-3 md:py-4">
                          ...
                          <div>
                            ...
                            <a
                              href="https://www.researchgate.net/publication/344521757_Sexual_and_Gender_Minority_Stress_Amid_the_COVID-19_Pandemic_Implications_for_LGBTQ_Young_Persons'_Mental_Health_and_Well-Being"
                              target="_blank"
                              rel="noreferrer"
                              className="underline decoration-[var(--color-gold)] underline-offset-2 hover:opacity-80"
                            >
                        ...
                        <li className="flex gap-3 py-3 md:py-4">
                          ...
                          <div>
                            ...
                            <a
                              href="https://www.researchgate.net/publication/342282937_LGBTQ_Populations_Psychologically_Vulnerable_Communities_in_the_COVID-19_Pandemic"
                              target="_blank"
                              rel="noreferrer"
                              className="underline decoration-[var(--color-gold)] underline-offset-2 hover:opacity-80"
                            >
                        ...
                        <li className="flex gap-3 py-3 md:py-4">
                          ...
                          <div>
                            ...
                            <a
                              href="https://www.researchgate.net/publication/310161801_Effectiveness_of_Universal_School-Based_Mental_Health_Awareness_Programs_Among_Youth_in_the_United_States_A_Systematic_Review"
                              target="_blank"
                              rel="noreferrer"
                              className="underline decoration-[var(--color-gold)] underline-offset-2 hover:opacity-80"
                            >
        ...
        {/* Mobile-only truncation CSS */}
        <style jsx global>{`
          /* On mobile, hide list items 3+ unless the card is expanded */
          @media (max-width: 767px) {
            article[data-truncate="true"]:not([data-expanded="true"]) ul > li:nth-child(n + 3) {

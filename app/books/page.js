                  ...
                  <div className="flex flex-col lg:flex-row gap-10 lg:gap-12">
                    ...
                    <div className="lg:w-2/3">
                      ...
                      <div className="md:hidden mt-4">
                        <label
                          htmlFor="more-c1"
                          className="rounded-full border border-white/20 bg-white/5 px-3 py-1.5 text-[12px] font-semibold tracking-wide hover:bg-white/10 active:translate-y-[1px] cursor-pointer"
                        >
                          <span className="peer-checked:hidden">Show all</span>

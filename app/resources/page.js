  ...
  return (
    <main className="min-h-screen w-full bg-[var(--color-teal-850)] text-[var(--color-cream)]">
      <div className="mx-auto max-w-[1200px] px-6 py-20">
        <h1 className="font-serif text-4xl mb-6">Resources</h1>
        ...
        <section className="grid gap-6 sm:grid-cols-2">
          <div className="rounded-lg border border-white/10 p-6">
            <h3 className="font-serif text-xl mb-2">Stress Toolkit (PDF)</h3>
            <p className="opacity-90">Evidence-based techniques you can use in minutes.</p>
          </div>
          <div className="rounded-lg border border-white/10 p-6">
            <h3 className="font-serif text-xl mb-2">Reading List</h3>

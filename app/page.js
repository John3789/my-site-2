...
/>
      ...
      <div aria-hidden className="sm:h-8 md:h-8 sm:bg-[var(--color-teal-800) md:bg-[var(--color-teal-800)]" />

      {/* DESKTOP/TABLET nameplate — unchanged */}
      <section id="home" className="sm:bg-[var(--color-teal-800)] md:bg-[var(--color-teal-800)] !text-[var(--color-cream)]">

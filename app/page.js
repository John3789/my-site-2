...
export default function Home() {
  ...
  // Your chosen fixed zooms; hook just guards/normalizes iOS viewport math
  ...
  return (
    <main id="main" className="!bg-[var(--color-teal-850)] text-[var(--color-cream)] text-[17px]">
      ...
      <section className="relative h-[100dvh] xl:h-[88.8svh] overflow-hidden">
        ...
        <div
          className="md:hidden absolute inset-x-0 bottom-0 z-30 px-4 pointer-events-none landscape:translate-y-5"
      ...
      {/* ===========================================================
          MOBILE CONTENT (zoom wrapper lives ONLY here)
          =========================================================== */}
      <div className="lg:hidden">
        ...
        >
          ...
          <section id="resources" className="w-full">
            ...
            {/* end mobile zoom subtree */}
          </section>
        </div>
      </div>

      {/* ===========================================================
          DESKTOP/TABLET CONTENT (no zoom wrapper)
          =========================================================== */}

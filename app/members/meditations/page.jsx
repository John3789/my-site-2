...
">
        <div className="relative mx-auto max-w-[1100px] px-6 py-3">
          <div ref={navScrollRef} className="flex gap-2 overflow-x-auto no-scrollbar scroll-smooth" onScroll={updateNavScrollState}>
            ...
            <a href="/members" className="flex-shrink-0 inline-flex items-center rounded-full border border-[var(--color-gold)] bg-[var(--color-gold)] px-3.5 py-1.5 text-xs font-semibold tracking-wide text-black shadow-sm transition active:scale-95">
              Members Home
            </a>
...
<div className="mt-8 max-[998px]:block min-[999px]:hidden">
    ...
    >
      <span className="truncate">Members Home</span>
    </a>

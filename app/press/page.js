  ...
  return (
    <main className="min-h-screen w-full bg-[var(--color-teal-850)] text-[var(--color-cream)]">
      <div className="mx-auto max-w-[1200px] px-6 py-20">
        <h1 className="font-serif text-4xl opacity-90 mb-6">Press</h1>
        ...
        <section className="space-y-6">
          <div className="rounded-lg border border-white/10 p-6">
            <h3 className="font-serif text-xl opacity-90 mb-2">Interview — Coming Soon</h3>
            <p className="opacity-90">Podcast conversation on single-session interventions.</p>
          </div>
          <div className="rounded-lg border border-white/10 p-6">
            <h3 className="font-serif text-xl opacity-90 mb-2">Op-Ed — Coming Soon</h3>

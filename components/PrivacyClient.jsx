        ...
        >
          <main className="min-h-screen w-full bg-[var(--color-teal-850)] text-[var(--color-cream)]">
            <div className="mx-auto max-w-[1000px] px-6 py-20 opacity-90">
              ...
              <p className="mb-8">
                Your privacy is important to Dr. Juan Pablo Salerno
                <sup className="text-xs">™</sup>. This Privacy Policy explains how we collect, use,
                and protect your information when you use this website and related services.
              </p>
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    Contact details (such as name, email, or phone number) when you sign up,
                    purchase, or contact us.
                  </li>
                  <li>
                    Payment information is processed securely by third-party providers (e.g.,
                    Stripe, PayPal). We do not store your credit card details.
                  </li>
                  <li>
                    Technical information (such as cookies and analytics data) to help improve site
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Send confirmations, reminders, or updates related to your purchases or sessions.
                  </li>
                  <li>Improve site functionality and content through analytics.</li>
                  <li>
                    With your consent, share newsletters or promotional content (you may unsubscribe
                    at any time).
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-10">
                ...
                <p className="mb-3">
                  We may share information with trusted third-party providers who perform services
                  on our behalf (such as payment processing, analytics, or email delivery). These
              ...
              <section className="mb-10">
                ...
                <p className="mb-3">
                  We take reasonable measures to safeguard your personal information. However, no
                  system can guarantee absolute security.
                </p>
                <p>
                  This site may be hosted on servers located outside your country. By using the
                  site, you consent to the transfer of information as needed.
                </p>
              </section>
              ...
              <section className="mb-10">
                ...
                <p>
                  ...
                  understand traffic and improve user experience. You can disable cookies in your
                  browser settings, though some site functions may be affected.
                </p>
              </section>
              ...
              <section className="mb-10">
                ...
                <p>
                  Our services are not directed toward children under 13 (or 16 where applicable).
                  We do not knowingly collect personal information from children. If we become
                  aware that a child has provided personal data, we will delete it promptly.
                </p>
              </section>
              ...
              <section className="mb-10">
                ...
                <p>
                  ...
                  contacting us at: drjuanpablosalerno@gmail.com.
                </p>
              </section>

...
<h1
  className="font-serif font-semibold uppercase tracking-[0.02em] text-[var(--color-cream)] text-center leading-[1.05] drop-shadow-[0_2px_6px_rgba(0,0,0,0.35)] !text-[clamp(28px,11.3vw,44px)] [@media(orientation:landscape)_and_(max-width:900px)]:hidden">
            ...
            <div className="mx-auto max-w-[1400px] px-6 pt-40 pb-10">
              ...
              <div className="max-w-4xl mx-auto text-center landscape:max-w-2xl lg:landscape:max-w-4xl">
                <p className="font-serif leading-[1.08] text-[clamp(28px,4.2vw,48px)] opacity-90">
                  “I believe everyone has the power to heal, awaken potential, and live with greater purpose —
                  my mission is to weave scientific insight and transformational wisdom to guide the way.”
                </p>
                  ...
                  <ul className="text-base leading-[1.7] opacity-90 mb-6 max-w-xl space-y-3 text-left mx-auto lg:mx-0">
                    ...
                    <li className="flex gap-2">
                      ...
                      <span><strong>Scale</strong> — Strengthen and integrate organizational resilience &amp; wellness.</span>
                                    ...
                                    <div className="flex justify-center lg:justify-start">
                    <Link href="/consulting" className="link">Book Consulting With Dr. Salerno →</Link>
                  </div>
                  </div>
                {/* Right: image */}
<div className="lg:col-span-6 w-full max-w-[680px] lg:max-w-[780px] mx-auto lg:mx-0 [@media(orientation:landscape)_and_(max-width:900px)]:max-w-[560px]">                  
